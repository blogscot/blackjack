...
## Exercise details
Note: This exercise will use the completed code from the Deck of Cards Exercise, so if you haven't already completed it you will either need to grab the finished source code (currently this is in the p8 branch), or you will need to complete the exercise on your own.
